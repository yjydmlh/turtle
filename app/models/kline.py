...
class Kline(Base):
    ...
    open_price = Column(Numeric(20, 8), nullable=False, comment="开盘价")
    high_price = Column(Numeric(20, 8), nullable=False, comment="最高价")
    low_price = Column(Numeric(20, 8), nullable=False, comment="最低价")
    close_price = Column(Numeric(20, 8), nullable=False, comment="收盘价")
    volume = Column(Numeric(30, 8), nullable=False, comment="成交量")
    quote_volume = Column(Numeric(30, 8), nullable=False, comment="成交额(计价货币)")
